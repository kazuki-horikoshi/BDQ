...
# Morning
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_20-36-08_[0, 0, 0, 0, 0, 1, 1, 1].pkl" #1.12
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_20-34-54_[1, 0, 0, 0, 0, 1, 1, 1].pkl" #1.11
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_20-34-40_[0, 1, 0, 0, 0, 1, 1, 1].pkl" #1.10
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_20-34-32_[1, 1, 0, 0, 0, 1, 1, 1].pkl" #1.9

# Noon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_23-35-22_[0, 0, 0, 0, 0, 0, 0, 1].pkl" #1.8
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_23-35-19_[1, 0, 0, 0, 0, 0, 0, 1].pkl" #1.7
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_23-35-16_[0, 1, 0, 0, 0, 0, 0, 1].pkl" #1.6
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_23-35-12_[1, 1, 0, 0, 0, 0, 0, 1].pkl" #1.5

## Afternoon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_18-03-08_[0, 0, 0, 1, 1, 1, 1, 1].pkl" #1.4
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_18-02-28_[1, 0, 0, 1, 1, 1, 1, 1].pkl" #1.3
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_18-01-50_[0, 1, 0, 1, 1, 1, 1, 1].pkl" #1.2
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_18-01-08_[1, 1, 0, 1, 1, 1, 1, 1].pkl" #1.1

# Transitions
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-22_02-08-40_[0, 0, 0, 1, 1, 0, 0, 1].pkl" #1.16
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-22_02-08-27_[1, 0, 0, 1, 1, 0, 0, 1].pkl" #1.15
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-22_02-08-14_[0, 1, 0, 1, 1, 0, 0, 1].pkl" #1.14
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-22_02-06-01_[1, 1, 0, 1, 1, 0, 0, 1].pkl" #1.13
