...
# Morning
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_22-28-40_[0, 0, 0, 0, 0, 1, 1, 1].pkl" #1.12
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_22-53-17_[1, 0, 0, 0, 0, 1, 1, 1].pkl" #1.11
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_22-50-56_[0, 1, 0, 0, 0, 1, 1, 1].pkl" #1.10
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_19-52-23_[1, 1, 0, 0, 0, 1, 1, 1].pkl" #1.9

# Noon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_01-03-58_[0, 0, 0, 0, 0, 0, 0, 1].pkl" #1.8
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_01-25-27_[1, 0, 0, 0, 0, 0, 0, 1].pkl" #1.7
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_01-25-07_[0, 1, 0, 0, 0, 0, 0, 1].pkl" #1.6
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_01-04-15_[1, 1, 0, 0, 0, 0, 0, 1].pkl" #1.5

## Afternoon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_10-11-06_[0, 0, 0, 1, 1, 1, 1, 1].pkl" #1.4
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_20-17-11_[1, 0, 0, 1, 1, 1, 1, 1].pkl" #1.3
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_20-16-38_[0, 1, 0, 1, 1, 1, 1, 1].pkl" #1.2
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_17-52-00_[1, 1, 0, 1, 1, 1, 1, 1].pkl" #1.1

# Transitions
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_05-32-27_[0, 0, 0, 1, 1, 0, 0, 1].pkl" #1.16
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_03-52-07_[1, 0, 0, 1, 1, 0, 0, 1].pkl" #1.15
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-21_03-53-16_[0, 1, 0, 1, 1, 0, 0, 1].pkl" #1.14
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-20_22-27-56_[1, 1, 0, 1, 1, 0, 0, 1].pkl" #1.13
