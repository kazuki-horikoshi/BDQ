...
# Morning
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_21-29-36_[0, 0, 0, 0, 0, 1, 1, 1].pkl" #1.12
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_21-29-32_[1, 0, 0, 0, 0, 1, 1, 1].pkl" #1.11
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_21-29-23_[0, 1, 0, 0, 0, 1, 1, 1].pkl" #1.10
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_19-10-47_[1, 1, 0, 0, 0, 1, 1, 1].pkl" #1.9

# Noon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_19-10-44_[0, 0, 0, 0, 0, 0, 0, 1].pkl" #1.8
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_19-10-39_[1, 0, 0, 0, 0, 0, 0, 1].pkl" #1.7
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_16-50-58_[0, 1, 0, 0, 0, 0, 0, 1].pkl" #1.6
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_16-50-16_[1, 1, 0, 0, 0, 0, 0, 1].pkl" #1.5

# Afternoon
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_16-44-49_[0, 0, 0, 1, 1, 1, 1, 1].pkl" #1.4
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_14-10-15_[1, 0, 0, 1, 1, 1, 1, 1].pkl" #1.3
model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_14-10-11_[0, 1, 0, 1, 1, 1, 1, 1].pkl" #1.2
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_14-10-01_[1, 1, 0, 1, 1, 1, 1, 1].pkl" #1.1

# Transitions
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-11_10-16-53_[0, 0, 0, 1, 1, 0, 0, 1].pkl" #1.16
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_23-51-17_[1, 0, 0, 1, 1, 0, 0, 1].pkl" #1.15
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-10_23-51-13_[0, 1, 0, 1, 1, 0, 0, 1].pkl" #1.14
#model_file_name = "Branching_Dueling-reduceLocalMax_TD-target-mean_TD-errors-aggregation-v2_granularity-6_2021-10-11_00-01-50_[1, 1, 0, 1, 1, 0, 0, 1].pkl" #1.13
