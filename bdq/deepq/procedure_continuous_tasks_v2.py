...
def learn_continuous_tasks(env,
    ...
    rewards_df.to_csv("/home/ylei/Desktop/Github/action-branching-agents/agents/bdq/trained_models/emulator-v0/"+rewards_save_name+"6.csv")

    obs_save_name = "observations"
    # save the record
    obs_name = ["Room T", "vAir1", "vAir2", "vAir3", "vAir4", "Outdoor T", "Solar Radiation", "hour", "occupancyFlag", "Time", "Air Flow", "Energy", "PMV1", "PMV2", "PMV3", "PMV4","Reward" , "Act_T", "Act_F1", "Act_F2", "Act_F3", "Act_F4"]
    obs_df = pd.DataFrame(observations, index = np.array(timeStamp), columns = obs_name)
    obs_df.to_csv("/home/ylei/Desktop/Github/action-branching-agents/agents/bdq/trained_models/emulator-v0/"+obs_save_name+"6.csv")
