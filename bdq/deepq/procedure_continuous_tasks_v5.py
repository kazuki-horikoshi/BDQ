...
def learn_continuous_tasks(env,
          ...
          target_network_update_freq=96*7,
    ...
    rewards_save_name = "daily_rewards"+csvSaveName
    # save the episode/daily rewards into csv
    rewards_df = pd.DataFrame({'episode_rewards':episode_rewards})
    rewards_df.to_csv("/home/ylei/Desktop/Github/action-branching-agents/agents/bdq/trained_models/emulator-v0/"+rewards_save_name+".csv")

    obs_save_name = "observations"+csvSaveName
    # save the record
    ...
    obs_df.to_csv("/home/ylei/Desktop/Github/action-branching-agents/agents/bdq/trained_models/emulator-v0/"+obs_save_name+".csv")
