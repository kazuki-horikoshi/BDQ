...
def learn_continuous_tasks(env,
    ...
    def evaluate(step, episode_number):
        ...
        for eval_episode in range(n_eval_episodes):
            ...
            for s in range(steps):
                ...
                # Step
                horizon = int(eval_episode*24*3600 + s*3600/4 + 7*3600)
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        with open("{}/{}_{}_{}.csv".format(results_dir, method_name, time_stamp, env_name), "w") as fw: 
            ...
            while True:
                ...
                horizon = int(len(episode_rewards)*24*3600 + t_step*3600/4 + 7*3600) # calc the next control timestep
    ...
    obs_df_occ = obs_df.drop(obs_df[obs_df['nextOccupancyFlag'] == 0].index)
